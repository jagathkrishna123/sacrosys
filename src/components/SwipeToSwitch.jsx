  ...
  return (
   <div className="bg-green-900 p-3 rounded-full border-[2px] border-[#3461FF]">
     <div
      ...
      onClick={handleClick}>
      <div className={`h-10 md:h-14 w-32 md:w-44 rounded-full flex items-center justify-center text-white font-semibold text-lg transition-all duration-500 ease-in-out shadow-lg ${
          swiped
