...
>
  ...
  >
    {isOpen ? (
      ...
      {/* ===== MOBILE SIDEBAR ===== */}
{/* Backdrop (white blurred, same style as desktop) */}
<div
...
{/* Sidebar itself */}
<div
  className={`fixed top-0 right-0 h-full w-3/4 sm:w-1/2 bg-white/10 backdrop-blur-md shadow-xl z-[55] transform transition-transform duration-500 ease-in-out ${
...
>
  <div className="flex flex-col items-start p-6 text-white h-full">
    ...
    <div className="mt-auto w-full">
      <a
        className="block bg-cyan-800 text-white text-center px-5 py-3 rounded-lg font-medium hover:bg-cyan-400 transition"
        href="#"
      >
        Contact
      </a>
