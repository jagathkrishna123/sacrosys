...
const Header = () => {
  return (
     <div className='relative flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <div className='max-w-6xl relative z-10 w-full p-2'>
            <div className='max-w-2xl font-bold text-[34px] md:text-[40px] font-pop flex flex-col gap-4 md:gap-0 '>
                <div className='mb-4'>
                ...
                <div className='text-[13px] md:text-[16px] font-normal font-pop'>
