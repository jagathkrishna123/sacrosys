...
const Banner = () => {
  return (
    <div className="flex justify-center w-full p-4">
      <div
        className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-0 md:gap-[100px] rounded-xl shadow-2xl h-[420px] md:h-[380px] relative overflow-hidden "
        style={{
          background: 'linear-gradient(to right, #FF2DF7, #5200FF, #00F0FF)'
        }}
      >
        ...
        {/* Text & Input Section */}
        <div className="flex flex-col justify-center items-center md:items-start w-full md:w-2/3 p-4 md:p-8 text-white space-y-4">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold leading-snug text-center md:text-left">
            Enhance Your Organization's Security <br /> 
            <span className="font-extrabold">Extra Eye</span>
          </h2>
